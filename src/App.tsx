    ...
    <div className="min-h-screen  bg-gray-950  text-white">
      <header className="border-b border-gray-800  bg-gray-900 px-6 lg:px-[1.25vw] py-4 lg:py-[0.833vw]">
        ...
        <aside className="lg:w-[15vw] shrink-0">
          <h2 className="text-xs lg:text-[0.725vw] leading-[0.759vw] font-semibold uppercase tracking-wider  text-gray-400 mb-3 lg:mb-[0.625vw] px-1 lg:px-[0.208vw]">
            Tickers
          </h2>
        ...
        <section className="flex-1  bg-gray-900 rounded-xl border  border-gray-800 p-3 lg:p-[1.25vw] shadow-sm">
