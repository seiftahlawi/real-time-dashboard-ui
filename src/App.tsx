      ...
      <header className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-xl font-bold tracking-tight">Market Dashboard</span>
          </div>
          <StatusBadge connected={connected} />
        </div>
      </header>

      <main className="max-w-[60vw] mx-auto px-4 sm:px-6 py-6 flex flex-col lg:flex-row gap-6">
        <aside className="lg:w-[15vw] shrink-0">
          <h2 className="text-xs lg:text-[0.625vw] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-3 px-1 lg:px-[0.208vw]">
            Tickers
          </h2>
